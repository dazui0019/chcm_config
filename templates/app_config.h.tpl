...
#define CVCC_OUTPUT_VOLTAGE_IDX_5V0 ( @CVCC_OUTPUT_VOLTAGE_IDX_5V0@U )
#define CVCC_OUTPUT_VOLTAGE_IDX_5V2 ( @CVCC_OUTPUT_VOLTAGE_IDX_5V2@U )
#define CVCC_OUTPUT_VOLTAGE_IDX_5V4 ( @CVCC_OUTPUT_VOLTAGE_IDX_5V4@U )
#define CVCC_OUTPUT_VOLTAGE_IDX_5V6 ( @CVCC_OUTPUT_VOLTAGE_IDX_5V6@U )
#define CVCC_OUTPUT_VOLTAGE_IDX_5V8 ( @CVCC_OUTPUT_VOLTAGE_IDX_5V8@U )
#define CVCC_OUTPUT_VOLTAGE_IDX_6V0 ( @CVCC_OUTPUT_VOLTAGE_IDX_6V0@U )
#define CVCC_OUTPUT_VOLTAGE_IDX_6V2 ( @CVCC_OUTPUT_VOLTAGE_IDX_6V2@U )
#define CVCC_OUTPUT_VOLTAGE_IDX_6V4 ( @CVCC_OUTPUT_VOLTAGE_IDX_6V4@U )
#define CVCC_OUTPUT_VOLTAGE_IDX_6V6 ( @CVCC_OUTPUT_VOLTAGE_IDX_6V6@U )
#define CVCC_OUTPUT_VOLTAGE_IDX_6V8 ( @CVCC_OUTPUT_VOLTAGE_IDX_6V8@U )
#define CVCC_OUTPUT_VOLTAGE_IDX_7V0 ( @CVCC_OUTPUT_VOLTAGE_IDX_7V0@U )
#define CVCC_OUTPUT_VOLTAGE_IDX_7V2 ( @CVCC_OUTPUT_VOLTAGE_IDX_7V2@U )
#define CVCC_OUTPUT_VOLTAGE_IDX_7V4 ( @CVCC_OUTPUT_VOLTAGE_IDX_7V4@U )
#define CVCC_OUTPUT_VOLTAGE_IDX_7V6 ( @CVCC_OUTPUT_VOLTAGE_IDX_7V6@U )
#define CVCC_OUTPUT_VOLTAGE_IDX_7V8 ( @CVCC_OUTPUT_VOLTAGE_IDX_7V8@U )
#define CVCC_OUTPUT_VOLTAGE_IDX_8V0 ( @CVCC_OUTPUT_VOLTAGE_IDX_8V0@U )
#define CVCC_OUTPUT_VOLTAGE_IDX_8V2 ( @CVCC_OUTPUT_VOLTAGE_IDX_8V2@U )
#define CVCC_OUTPUT_VOLTAGE_IDX_8V4 ( @CVCC_OUTPUT_VOLTAGE_IDX_8V4@U )
...
extern const __attribute__ ((section(".parameter_config_4"))) uint8_t u8_ti_sweep_led_nums;
extern const __attribute__ ((section(".parameter_config_5"))) uint8_t u8_ti_sweep_led_k[TI_SWEEP_USER_STEP + 1u][TI_USED_LED_NUMS];
...
#define LOCK_MODE1_TOTAL_STEP    ( @LOCK_MODE1_TOTAL_STEP@U )  /**< 闭锁模式1总步数 */
#define LOCK_MODE2_TOTAL_STEP    ( @LOCK_MODE2_TOTAL_STEP@U )  /**< 闭锁模式2总步数 */
#define LOCK_MODE3_TOTAL_STEP    ( @LOCK_MODE3_TOTAL_STEP@U )  /**< 闭锁模式3总步数 */
#define LOCK_MODE4_TOTAL_STEP    ( @LOCK_MODE4_TOTAL_STEP@U )  /**< 闭锁模式4总步数 */
#define LOCK_MODE5_TOTAL_STEP    ( @LOCK_MODE5_TOTAL_STEP@U )  /**< 闭锁模式5总步数 */
#define UNLOCK_MODE1_TOTAL_STEP  ( @UNLOCK_MODE1_TOTAL_STEP@U )  /**< 解锁模式1总步数 */
#define UNLOCK_MODE2_TOTAL_STEP  ( @UNLOCK_MODE2_TOTAL_STEP@U )  /**< 解锁模式2总步数 */
#define UNLOCK_MODE3_TOTAL_STEP  ( @UNLOCK_MODE3_TOTAL_STEP@U )  /**< 解锁模式3总步数 */
#define UNLOCK_MODE4_TOTAL_STEP  ( @UNLOCK_MODE4_TOTAL_STEP@U )  /**< 解锁模式4总步数 */
#define UNLOCK_MODE5_TOTAL_STEP  ( @UNLOCK_MODE5_TOTAL_STEP@U )  /**< 解锁模式5总步数 */
...
extern const __attribute__ ((section(".parameter_config_41"))) uint8_t u8_hb_adb_mode; // 配置当前HB是否为ADB模式

/* 恒流类型9输出通道: 单独的PL通道 */
extern const __attribute__ ((section(".parameter_config_42"))) uint8_t u8_pl_0_cvcc_map_array[2][2];
...
extern const __attribute__ ((section(".parameter_config_59"))) uint8_t u8_drl_ntc_default_derate;
