...
4. Verify the generated files under `output/`.
5. When asked to sync, commit only the intended changes and push to `origin/main` without touching unrelated user edits.
